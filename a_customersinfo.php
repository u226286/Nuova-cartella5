...
// End of mofidication Flexibility of Export Records Options, by Masino Sinaga, May 14, 2012
	...
	function Recordset_Selecting() {

		// Enter your code here	
	}

	// Recordset Selected event
	function Recordset_Selected() {
	...
	// Grid Inserted event
	function Grid_Inserted() {

		//echo "Grid Inserted";
	}

	// Grid Updating event
	function Grid_Updating() {
	...
	// Grid Updated event
	function Grid_Updated() {

		//echo "Grid Updated";
	}

	// Row Deleting event
	function Row_Deleting() {
